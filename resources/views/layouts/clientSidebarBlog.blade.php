<div class="sidebar fl-left">
            <div class="section" id="category-product-wp">
                ...
                <div class="secion-detail">
                    <ul class="list-item">
                        @foreach ($list_category_post as $categoryParent)
                             <li>
                            <a href="{{ route("detail.catPost", $categoryParent->id) }}" title="">{{ $categoryParent->post_cat_name }}</a>
                            @include('components.child_menu_post', ["categoryParent" => $categoryParent])
                        </li>
                        @endforeach
                    </ul>
                </div>
