                ...
                <div class="card-body">
                    <form action="{{ route("product.cat.store") }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="category_description" id="" class="form-control" cols="10" rows="6"></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="category_status" id="exampleRadios1" value="pending" checked>
                                <label class="form-check-label" for="exampleRadios1">
                                    Chờ duyệt
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="category_status" id="exampleRadios2" value="licensed">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            @foreach ($list_category as $item)
                                ...
                                <td>{{ $item->slug }}</td>
                                <td> <span class="badge badge-warning"> {{ $item->category_status }}</span></td>
