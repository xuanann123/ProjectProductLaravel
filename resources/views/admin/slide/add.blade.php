            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-check">
                        ...
                        <input class="form-check-input" type="radio" name="status"  id="status" value="Hoạt động" >
                    ...
                    <div class="form-check">
                        {{-- Cái này dúng để định nghĩa cấp quyền cho một sản phẩm --}}
                        <input class="form-check-input" type="radio" name="status"  id="status" value="Chờ duyệt">
